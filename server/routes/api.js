...
function getMedsList(drug) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    axios.get(queryUrl).then(function(response) {
      ...
      if(!conceptGroup) {
        return reject("Invalid Search Term");
      }
...
function getMultipleInteractions(drugsList) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    axios.get(queryUrl).then(function(response) {
      ...
      } else reject('No Known Interactions');
...
module.exports = {
  getMedsList: getMedsList,
  getMultipleInteractions: getMultipleInteractions
};
